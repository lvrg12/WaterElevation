...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=small_lubbock&box=-101.835019,33.620351,-101.921321,33.548486
...
-----------
  ...
  * small_lubbock Height Map (ASTER 30m).png
  ...
  * small_lubbock Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * small_lubbock Height Map (SRTM3 v4.1).png
  ...
  * small_lubbock Height Map (SRTM30 Plus).png
  ...
  * small_lubbock Height Map (USGS NED 10m).png
...
These heightmaps were adjusted such that 936m (actual) is equal to 40m in
